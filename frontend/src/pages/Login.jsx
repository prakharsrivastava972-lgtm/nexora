    ...
    <div className="relative min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-900 px-4 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-sm">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-indigo-600 dark:text-indigo-400 mb-2">Welcome to NEXORA</h1>
          <p className="text-slate-500 dark:text-slate-400 text-sm">Your personalized learning and recommendation journey starts here.</p>
        </div>
